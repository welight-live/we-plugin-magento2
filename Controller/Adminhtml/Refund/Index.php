...
namespace UOL\welight\Controller\Adminhtml\Refund;
...
class Index extends Pageable
{
    ...
    public function execute()
    {
        ...
        $resultPage->getLayout()->getBlock('adminhtml.block.welight.refund.content')->setData('adminurl', $this->getAdminUrl());
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('WE_welight::Refund');
    }
}
