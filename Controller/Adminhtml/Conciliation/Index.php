...
namespace UOL\welight\Controller\Adminhtml\Conciliation;
...
class Index extends Pageable
{
    ...
    public function execute()
    {
        ...
        $resultPage->getLayout()->getBlock('adminhtml.block.welight.conciliation.content')->setData('adminurl', $this->getAdminUrl());
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('WE_welight::Conciliation');
    }
}
