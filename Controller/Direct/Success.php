...
class Success extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if($this->link())
            $resultPage->getLayout()->getBlock('welight.payment.success')->setPaymentLink($this->link());
        $resultPage->getLayout()->getBlock('welight.payment.success')->setPaymentType($this->type());
        $resultPage->getLayout()->getBlock('welight.payment.success')->setOrderId($this->order()->getIncrementId());
        $resultPage->getLayout()->getBlock('welight.payment.success')->setCanViewOrder(true);
        $this->clearSession();
        return $resultPage;
    }
