...
define(
    ...
    function ($, Component, quote, fullScreenLoader, setPaymentInformationAction, placeOrder, directPaymentValidator) {
        ...
        return Component.extend({
            defaults: {
                template: 'WE_welight/payment/online-debit-form',
            ...
            placeOrder: function () {
                ...
                $.when(setPaymentInformationAction(this.messageContainer, {
                    'method': self.getCode(),
                    'additional_data': {
                        'online_debit_document': (self.onlineDebitDocument()) ? self.onlineDebitDocument() : document.getElementById('welight_online_debit_online_debit_document').value,
                        'online_debit_hash': welightDirectPayment.getSenderHash(),
            ...
            validatePlaceOrder: function(checkedBank) {
              ...
              return validateDocumentFinal(document.getElementById('welight_online_debit_online_debit_document')) && ! invalidBank;
            },
