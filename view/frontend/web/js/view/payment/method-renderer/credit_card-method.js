...
define(
    [
        ...
        'WE_welight/js/model/credit-card',
    ...
    function ($, Component, quote, fullScreenLoader, setPaymentInformationAction, placeOrder, directPaymentValidator, creditCard) {
        ...
        return Component.extend({
            defaults: {
                template: 'WE_welight/payment/credit-card-form',
                brazilFlagPath: window.checkoutConfig.brazilFlagPath,
                welightCcSessionId: window.checkoutConfig.library.session
//                totals: parseFloat(
...
//                )
            ...
            getwelightCcMonthsValues: function() {
          ...
          getwelightCcYearsValues: function() {
            ...
            placeOrder: function () {
                ...
                if (! self.validatePlaceOrder()) {
                  ...
                  return;
                    ...
                    var welightHash = welightDirectPayment.getSenderHash();
                    var param = {
                      cardNumber: unmask(document.getElementById('welight_credit_card_number').value),
                      ...
                      success: function (response) {
                        ...
                        self.finishOrder(self, paymentData, messageContainer, welightHash);
                      },
                    ...
                    welightDirectPayment.createCardToken(param);
                }
            },
            ...
            finishOrder: function(self, paymentData, messageContainer, welightHash) {
              $.when(setPaymentInformationAction(messageContainer, {
                ...
                'additional_data': {
                    ...
                    'credit_card_hash' : welightHash,//welightDirectPayment.getSenderHash(),
