Módulo de integração welight para Magento 2.x
====================================================

[![Code Climate](https://codeclimate.com/github/welight/magento2/badges/gpa.svg)](https://codeclimate.com/github/welight/magento2)

---
Descrição
---------
---
Com o módulo instalado e configurado, você pode pode oferecer o welight como opção de pagamento em sua loja. O módulo utiliza as seguintes funcionalidades que o welight oferece na forma de APIs:
...
1. Instale via packagist 
   - ```composer require welight/magento2```
...
A atualização do módulo do welight é feita através do **composer** e pode ser feita de diversas maneiras, de acordo com suas preferências. Uma forma é através dos comandos:
1. ```composer update welight/magento2```
2. ```composer update welight/welight-php-sdk```
...
5. Acesse a seção do welight através da interface administrativa da sua loja, confira as informações e configurações do welight e seus meios de pagamento e clique no botão para salvar.

**Observações** 
- Em alguns casos, o Magento não atualiza os arquivos estáticos gerados, podendo ser necessário atualizar os mesmos via interface administrativa, comandos do terminal ou removendo diretamente conteúdo da pasta *pub/static/frontend/Magento/seu_tema/seu_idioma/WE_welight*.
...
------------
---
Para acessar e configurar o módulo acesse o menu welight -> Configurações. As opções disponíveis estão descritas abaixo.

 -------------------------
 **Configurações Gerais**
 
 - **ambiente**: especifica em que ambiente as transações serão feitas *(produção/sandbox)*.
 - **e-mail**: e-mail cadastrado no welight.
 - **token**: token cadastrado no welight.
 - **url de redirecionamento**: ao final do fluxo de pagamento no welight, seu cliente será redirecionado automaticamente para a página de confirmação em sua loja ou então para a URL que você informar neste campo. Para ativar o redirecionamento ao final do pagamento é preciso ativar o serviço de [Pagamentos via API]. Obs.: Esta URL é informada automaticamente e você só deve alterá-la caso deseje que seus clientes sejam redirecionados para outro local.
 - **url de notificação**: sempre que uma transação mudar de status, o welight envia uma notificação para sua loja. **O valor padrão que deve ser utilizado pelo módulo é: http://www.minhaloja.com.br/index.php/welight/notification/response**
 ...
 - **diretório**: informe o local e nome do arquivo a partir da raíz de instalação do Magento onde se deseja criar o arquivo de log. Ex.: var/log/welight.log. 
     - *Por padrão o módulo virá configurado para salvar o arquivo de log em var/log/welight.log*.
 - **listar transações abandonadas?**: ativa/desativa a pesquisa de transações que foram abandonadas no checkout do welight.
 ...
 - **habilitar recuperação de carrinho**: Habilita a recuperação de carrinho do welight. (por padrão está desabilitada)
 ...
 **Configurar Tipos de Checkout**
 Nesta seção você irá configurar os meios de pagamento do welight que deseja disponibilizar na sua loja.
 > Consulte na sua conta do welight os meios de pagamento que estão habilitados.
 
 - *welight (Padrão ou Lightbox)*
   - **ativar**: ativa/desativa o meio de pagamento welight (padrão ou lightbox).
   ...
   - **oferecer desconto para ...**: ativa/desativa desconto para checkouts por meio de pagamento (cartão de crédito, boleto, débito online, depósito em conta e saldo welight)
...
------------
---
 Para realizar consultas e outras operações acesse o menu welight -> *Transação*, onde *Transação* pode ser escolhida as opções: Conciliação, Abandonadas, Cancelamento, Estorno. As opções disponíveis estão descritas abaixo:
 ...
 - **conciliação**: permite consultar as transações efetivadas no welight nos últimos 30 dias. A pesquisa retornará um comparativo com o status das transações em sua base local e o status atual da transação no welight, desta forma você pode identificar e atualizar transações com status divergentes.
...
---------
---
 - O welight somente aceita pagamento utilizando a moeda Real brasileiro (BRL).
...
* Obs.: O Pull Request não deve ser enviado para o branch master e sim para o branch correspondente a versão ou para a branch de desenvolvimento.
  ...
  [API de Pagamentos]: https://dev.welight.uol.com.br/documentacao/pagamentos
  [API de Notificações]: https://welight.uol.com.br/v2/guia-de-integracao/api-de-notificacoes.html
  [fórum]: https://comunidade.welight.uol.com.br/hc/pt-br/community/topics
  [Pagamentos via API]: https://welight.uol.com.br/integracao/pagamentos-via-api.jhtml
  [Notificação de Transações]: https://welight.uol.com.br/integracao/notificacao-de-transacoes.jhtml
  [Magento]: https://www.magentocommerce.com/
  [PHP]: http://www.php.net/
  [SPL]: http://php.net/manual/en/book.spl.php
  [cURL]: http://php.net/manual/en/book.curl.php
  [DOM]: http://php.net/manual/en/book.dom.php
  [GitHub]: https://github.com/welight/magento2
