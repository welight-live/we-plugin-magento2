...
use welight\Domains\Requests\DirectPayment\Boleto;
use UOL\welight\Model\Direct\Contracts\Checkout;
...
class BoletoMethod implements Checkout
{
    ...
    public function __construct(
        ...
        /** @var \welight\Domains\Requests\DirectPayment\Boleto _paymentRequest */
        $this->_paymentRequest = new Boleto();
    }

    /**
     * Create a new welight direct payment request
     *
     * @return string
     * @throws \Exception
     */
