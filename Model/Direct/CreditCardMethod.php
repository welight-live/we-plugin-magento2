 ...
 */
namespace UOL\welight\Model\Direct;
...
class CreditCardMethod
{
    ...
    public function __construct(
        ...
        /** @var \welight\Domains\Requests\DirectPayment\CreditCard _paymentRequest */
        $this->_paymentRequest = new \welight\Domains\Requests\DirectPayment\CreditCard();
    }
    /**
    ...
    {
        return $this->_paymentRequest->register($this->_library->getwelightCredentials());
    }
        ...
        if ($billing) {
            if (count($billing->getStreet()) === 4) {
                $this->_paymentRequest->setBilling()->setAddress()->withParameters(
                    ...
                    \UOL\welight\Helper\Data::fixPostalCode($billing->getPostcode()),
                    $billing->getCity(),
                ...
                $address = \UOL\welight\Helper\Data::addressConfig($billing['street']);
                $this->_paymentRequest->setBilling()->setAddress()->withParameters(
    ...
    {
//        if ($this->_scopeConfig->getValue('payment/welight/environment') == "sandbox") {
//            return "magento2@sandbox.welight.com.br"; //mock for sandbox
//        }
    ...
    /**
     * Set discounts using welight "extra amount" parameter
     */
