...
class PaymentDefaultlLightbox extends \Magento\Payment\Model\Method\AbstractMethod
{
     ...
     *
     */
    const PAYMENT_METHOD_welight_CODE = 'welight_default_lightbox';
    /**
     * @var string
     */
    protected $_code       = self::PAYMENT_METHOD_welight_CODE;
    /**
     * @var bool
     */
     ...
     * @param \UOL\welight\Helper\Library $helper
     */
    ...
    {
//        if ($this->getConfigData('checkout') == \UOL\welight\Model\System\Config\Checkout::DIRECT) {
//            return true;
//        }
        return false;
    }
    ...
    {
        if ($this->getConfigData('checkout') == \UOL\welight\Model\System\Config\Checkout::LIGHTBOX) {
            return true;
        }
        return false;
    }
    ...
    {
        return $this->_cart->getQuote()->getStore()->getUrl("welight/payment/checkout/");
    }
    ...
    {
        return $this->_cart->getQuote()->getStore()->getUrl("welight/payment/request/");
    }
    ...
    {
        return $this->_cart->getQuote()->getStore()->getUrl("welight/direct/payment");
    }
