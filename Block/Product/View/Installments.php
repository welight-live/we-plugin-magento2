...
namespace UOL\welight\Block\Product\View;
...
class Installments extends Template
{
     ...
     * @var \UOL\welight\Model\Direct\InstallmentsMethod
     */
    protected $_installmentFactory;

    /**
     * @param \Magento\Catalog\Block\Product\Context $context
     * @param \UOL\welight\Model\Direct\InstallmentsMethodFactory $installmentFactory
     */
    public function __construct(
        \Magento\Catalog\Block\Product\Context $context,
        \UOL\welight\Model\Direct\InstallmentsMethodFactory $installmentFactory
    ) {
    ...
    /**
     * Validate if the welight installments list in the product view is enabled
     * @return bool
     */
    public function isEnabled() {
        $status = $this->_scopeConfig->getValue('payment/welight/installments');
